...
export const buildSdkPicker = () => {
  const sdkSelector = document.getElementById('sdk_picker_v1');
  const sdkSelector_v2 = document.getElementById('sdk_picker_v2');
  ...
  for (let k in envs) {
    ...
    const option_v2 = document.createElement('option');
